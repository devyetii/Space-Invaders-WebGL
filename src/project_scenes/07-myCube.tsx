...
export default class myCube extends Scene {
    camera: Camera;
    ...
    public load(): void {
        ...
        this.game.loader.load({
            ...
            ["house-model"]:{url:'models/Suzanne/Suzanne.obj', type:'text'},
            ["house-texture"]:{url:'models/House/House.jpeg', type:'image'},
             ...Object.fromEntries(myCube.cubemapDirections.map(dir=>[dir, {url:`images/space/${dir}.png`, type:'image'}]))
    ...
    public start(): void {
        ...
        this.gl.pixelStorei(this.gl.UNPACK_ALIGNMENT, 4);
        for(let i = 0; i < 6; i++){
            this.gl.texImage2D(target_directions[i], 0, this.gl.RGBA, this.gl.RGBA, this.gl.UNSIGNED_BYTE, this.game.loader.resources[myCube.cubemapDirections[i]]);
        }
    ...
    public draw(deltaTime: number): void {
        ...
        //mat4.translate(playerMat, playerMat, [0,0,0]);
        ...
        let playerMat2 = mat4.clone(VP);
        

        mat4.translate(playerMat2, playerMat2, [0,2,0]);
        this.programs["cube"].setUniformMatrix4fv("MVP", false, playerMat2);
